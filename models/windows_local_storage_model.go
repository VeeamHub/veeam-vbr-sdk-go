...
//
// swagger:model WindowsLocalStorageModel
...
func (m *WindowsLocalStorageModel) UnmarshalJSON(raw []byte) error {
	// AO0
...
func (m WindowsLocalStorageModel) MarshalJSON() ([]byte, error) {
...
// Validate validates this windows local storage model
func (m *WindowsLocalStorageModel) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *WindowsLocalStorageModel) validateHostID(formats strfmt.Registry) error {
...
func (m *WindowsLocalStorageModel) validateMountServer(formats strfmt.Registry) error {
...
func (m *WindowsLocalStorageModel) validateRepository(formats strfmt.Registry) error {
...
// ContextValidate validate this windows local storage model based on the context it is used
func (m *WindowsLocalStorageModel) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *WindowsLocalStorageModel) contextValidateMountServer(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WindowsLocalStorageModel) contextValidateRepository(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WindowsLocalStorageModel) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *WindowsLocalStorageModel) UnmarshalBinary(b []byte) error {
	var res WindowsLocalStorageModel
