...
func (m *SmbStorageModel) UnmarshalJSON(raw []byte) error {
	// AO0
...
func (m SmbStorageModel) MarshalJSON() ([]byte, error) {
...
// Validate validates this smb storage model
func (m *SmbStorageModel) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SmbStorageModel) validateMountServer(formats strfmt.Registry) error {
...
func (m *SmbStorageModel) validateRepository(formats strfmt.Registry) error {
...
func (m *SmbStorageModel) validateShare(formats strfmt.Registry) error {
...
// ContextValidate validate this smb storage model based on the context it is used
func (m *SmbStorageModel) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SmbStorageModel) contextValidateMountServer(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SmbStorageModel) contextValidateRepository(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SmbStorageModel) contextValidateShare(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SmbStorageModel) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SmbStorageModel) UnmarshalBinary(b []byte) error {
	var res SmbStorageModel
