...
func (m *JobsResult) validateData(formats strfmt.Registry) error {
...
func (m *JobsResult) validatePagination(formats strfmt.Registry) error {
...
func (m *JobsResult) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *JobsResult) contextValidatePagination(ctx context.Context, formats strfmt.Registry) error {
