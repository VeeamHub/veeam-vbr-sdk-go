...
// ProxyExportSpec proxy export spec
//
// swagger:model ProxyExportSpec
type ProxyExportSpec struct {
	...
	// Unique: true
	Types []EProxyType `json:"types"`
}

// Validate validates this proxy export spec
func (m *ProxyExportSpec) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ProxyExportSpec) validateIds(formats strfmt.Registry) error {
...
func (m *ProxyExportSpec) validateNames(formats strfmt.Registry) error {
...
func (m *ProxyExportSpec) validateTypes(formats strfmt.Registry) error {
...
// ContextValidate validate this proxy export spec based on the context it is used
func (m *ProxyExportSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ProxyExportSpec) contextValidateTypes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProxyExportSpec) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ProxyExportSpec) UnmarshalBinary(b []byte) error {
	var res ProxyExportSpec
