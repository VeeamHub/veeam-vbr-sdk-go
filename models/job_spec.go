...
func (m *JobSpec) validateDescription(formats strfmt.Registry) error {
...
func (m *JobSpec) validateName(formats strfmt.Registry) error {
...
func (m *JobSpec) contextValidateType(ctx context.Context, formats strfmt.Registry) error {
