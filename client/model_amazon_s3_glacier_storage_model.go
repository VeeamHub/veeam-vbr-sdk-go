...
func NewAmazonS3GlacierStorageModel(account AmazonS3StorageAccountModel, bucket AmazonS3GlacierStorageBucketModel, id string, name string, description string, type_ ERepositoryType) *AmazonS3GlacierStorageModel {
