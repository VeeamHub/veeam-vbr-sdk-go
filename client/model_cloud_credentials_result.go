...
// CloudCredentialsResult struct for CloudCredentialsResult
...
func (o CloudCredentialsResult) MarshalJSON() ([]byte, error) {
...
type NullableCloudCredentialsResult struct {
	value *CloudCredentialsResult
	isSet bool
}

func (v NullableCloudCredentialsResult) Get() *CloudCredentialsResult {
	return v.value
}

func (v *NullableCloudCredentialsResult) Set(val *CloudCredentialsResult) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudCredentialsResult) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudCredentialsResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudCredentialsResult(val *CloudCredentialsResult) *NullableCloudCredentialsResult {
	return &NullableCloudCredentialsResult{value: val, isSet: true}
}

func (v NullableCloudCredentialsResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudCredentialsResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
