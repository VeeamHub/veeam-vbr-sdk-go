...
*RestoreApi* | [**InstantRecoveryVmwareFcdDismount**](docs/RestoreApi.md#instantrecoveryvmwarefcddismount) | **Post** /api/v1/restore/instantRecovery/vmware/fcd/{mountId}/dismount | Stop FCD Publishing
*RestoreApi* | [**InstantRecoveryVmwareFcdMigrate**](docs/RestoreApi.md#instantrecoveryvmwarefcdmigrate) | **Post** /api/v1/restore/instantRecovery/vmware/fcd/{mountId}/migrate | Start FCD Migration
*RestoreApi* | [**InstantRecoveryVmwareFcdMount**](docs/RestoreApi.md#instantrecoveryvmwarefcdmount) | **Post** /api/v1/restore/instantRecovery/vmware/fcd/ | Start Instant FCD Recovery
