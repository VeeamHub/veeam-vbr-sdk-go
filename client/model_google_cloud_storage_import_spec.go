...
// GoogleCloudStorageImportSpec struct for GoogleCloudStorageImportSpec
...
func NewGoogleCloudStorageImportSpec(name string, description string, tag string, type_ ERepositoryType, account GoogleCloudStorageAccountImportModel, bucket GoogleCloudStorageBucketModel, mountServer MountServerSettingsImportSpec) *GoogleCloudStorageImportSpec {
	this := GoogleCloudStorageImportSpec{}
	this.Name = name
...
func (o *GoogleCloudStorageImportSpec) GetAccount() GoogleCloudStorageAccountImportModel {
	if o == nil {
		var ret GoogleCloudStorageAccountImportModel
		return ret
	}
...
func (o GoogleCloudStorageImportSpec) MarshalJSON() ([]byte, error) {
...
type NullableGoogleCloudStorageImportSpec struct {
	value *GoogleCloudStorageImportSpec
	isSet bool
}

func (v NullableGoogleCloudStorageImportSpec) Get() *GoogleCloudStorageImportSpec {
	return v.value
}

func (v *NullableGoogleCloudStorageImportSpec) Set(val *GoogleCloudStorageImportSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableGoogleCloudStorageImportSpec) IsSet() bool {
	return v.isSet
}

func (v *NullableGoogleCloudStorageImportSpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGoogleCloudStorageImportSpec(val *GoogleCloudStorageImportSpec) *NullableGoogleCloudStorageImportSpec {
	return &NullableGoogleCloudStorageImportSpec{value: val, isSet: true}
}

func (v NullableGoogleCloudStorageImportSpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGoogleCloudStorageImportSpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
