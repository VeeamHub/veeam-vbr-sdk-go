...
// WithID adds the id to the get proxy params
func (o *GetProxyParams) WithID(id strfmt.UUID) *GetProxyParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get proxy params
func (o *GetProxyParams) SetID(id strfmt.UUID) {
	o.ID = id
}

// WithXAPIVersion adds the xAPIVersion to the get proxy params
func (o *GetProxyParams) WithXAPIVersion(xAPIVersion string) *GetProxyParams {
	o.SetXAPIVersion(xAPIVersion)
	return o
}

// SetXAPIVersion adds the xApiVersion to the get proxy params
func (o *GetProxyParams) SetXAPIVersion(xAPIVersion string) {
