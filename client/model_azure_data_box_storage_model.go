...
func NewAzureDataBoxStorageModel(account AzureDataBoxStorageAccountModel, container AzureDataBoxStorageContainerModel, hostId string, repository LinuxHardenedRepositorySettingsModel, mountServer MountServerSettingsModel, share SmbRepositoryShareSettingsModel, proxyAppliance S3CompatibleProxyModel, bucket WasabiCloudStorageBucketModel) *AzureDataBoxStorageModel {
