...
type GFSPolicySettingsMonthlyModel struct {
	...
	// Number of months to keep full backups for archival purposes. Possible values are from 1 through 999.
...
func (o *GFSPolicySettingsMonthlyModel) GetKeepForNumberOfMonths() int32 {
	if o == nil || isNil(o.KeepForNumberOfMonths) {
		var ret int32
		return ret
	}
...
func (o GFSPolicySettingsMonthlyModel) MarshalJSON() ([]byte, error) {
	...
	if !isNil(o.KeepForNumberOfMonths) {
