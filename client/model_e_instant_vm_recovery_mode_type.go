...
// All allowed values of EInstantVMRecoveryModeType enum
var AllowedEInstantVMRecoveryModeTypeEnumValues = []EInstantVMRecoveryModeType{
	"OriginalLocation",
	"Customized",
}
...
func (v *EInstantVMRecoveryModeType) UnmarshalJSON(src []byte) error {
	...
	for _, existing := range AllowedEInstantVMRecoveryModeTypeEnumValues {
...
// NewEInstantVMRecoveryModeTypeFromValue returns a pointer to a valid EInstantVMRecoveryModeType
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewEInstantVMRecoveryModeTypeFromValue(v string) (*EInstantVMRecoveryModeType, error) {
	ev := EInstantVMRecoveryModeType(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for EInstantVMRecoveryModeType: valid values are %v", v, AllowedEInstantVMRecoveryModeTypeEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v EInstantVMRecoveryModeType) IsValid() bool {
	for _, existing := range AllowedEInstantVMRecoveryModeTypeEnumValues {
		if existing == v {
			return true
		}
