...
// NfsStorageSpec NFS backup repository.
...
func NewNfsStorageSpec(share NfsRepositoryShareSettingsModel, repository NetworkRepositorySettingsModel, mountServer MountServerSettingsModel, hostId string, account WasabiCloudStorageAccountModel, container AzureArchiveStorageContainerModel, proxyAppliance S3CompatibleProxyModel, bucket WasabiCloudStorageBucketModel) *NfsStorageSpec {
	this := NfsStorageSpec{}
	this.HostId = hostId
