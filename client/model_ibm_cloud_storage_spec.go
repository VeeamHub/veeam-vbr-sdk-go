...
func NewIBMCloudStorageSpec(account IBMCloudStorageAccountModel, bucket IBMCloudStorageBucketModel, mountServer MountServerSettingsModel, name string, description string, type_ ERepositoryType) *IBMCloudStorageSpec {
