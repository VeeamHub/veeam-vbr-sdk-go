...
func NewAzureComputeCloudDeviceCodeModel(url string, verificationCode string, expirationTime time.Time, type_ ECloudCredentialsType) *AzureComputeCloudDeviceCodeModel {
