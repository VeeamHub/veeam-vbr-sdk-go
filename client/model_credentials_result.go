...
// CredentialsResult struct for CredentialsResult
...
func (o CredentialsResult) MarshalJSON() ([]byte, error) {
...
type NullableCredentialsResult struct {
	value *CredentialsResult
	isSet bool
}

func (v NullableCredentialsResult) Get() *CredentialsResult {
	return v.value
}

func (v *NullableCredentialsResult) Set(val *CredentialsResult) {
	v.value = val
	v.isSet = true
}

func (v NullableCredentialsResult) IsSet() bool {
	return v.isSet
}

func (v *NullableCredentialsResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCredentialsResult(val *CredentialsResult) *NullableCredentialsResult {
	return &NullableCredentialsResult{value: val, isSet: true}
}

func (v NullableCredentialsResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCredentialsResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
