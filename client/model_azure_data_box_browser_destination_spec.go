...
func NewAzureDataBoxBrowserDestinationSpec(containerName string, servicePoint string, credentialsId string, serviceType ECloudServiceType, newFolderName string) *AzureDataBoxBrowserDestinationSpec {
