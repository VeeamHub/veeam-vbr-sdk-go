...
func NewIBMCloudStorageBrowserDestinationSpec(connectionPoint string, regionId string, bucketName string, credentialsId string, serviceType ECloudServiceType, newFolderName string) *IBMCloudStorageBrowserDestinationSpec {
