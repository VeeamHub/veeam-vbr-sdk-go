...
// AmazonSnowballEdgeStorageSpec AWS Snowball Edge storage.
...
func NewAmazonSnowballEdgeStorageSpec(account AmazonSnowballEdgeStorageAccountModel, bucket AmazonSnowballEdgeStorageBucketModel, mountServer MountServerSettingsModel, name string, description string, type_ ERepositoryType) *AmazonSnowballEdgeStorageSpec {
	this := AmazonSnowballEdgeStorageSpec{}
	this.Name = name
...
func (o AmazonSnowballEdgeStorageSpec) MarshalJSON() ([]byte, error) {
...
type NullableAmazonSnowballEdgeStorageSpec struct {
	value *AmazonSnowballEdgeStorageSpec
	isSet bool
}

func (v NullableAmazonSnowballEdgeStorageSpec) Get() *AmazonSnowballEdgeStorageSpec {
	return v.value
}

func (v *NullableAmazonSnowballEdgeStorageSpec) Set(val *AmazonSnowballEdgeStorageSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableAmazonSnowballEdgeStorageSpec) IsSet() bool {
	return v.isSet
}

func (v *NullableAmazonSnowballEdgeStorageSpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAmazonSnowballEdgeStorageSpec(val *AmazonSnowballEdgeStorageSpec) *NullableAmazonSnowballEdgeStorageSpec {
	return &NullableAmazonSnowballEdgeStorageSpec{value: val, isSet: true}
}

func (v NullableAmazonSnowballEdgeStorageSpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAmazonSnowballEdgeStorageSpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
