...
func NewInstantViVMOriginalLocationRecoverySpec(objectRestorePointId string, type_ EInstantVMRecoveryModeType, secureRestore SecureRestoreSpec) *InstantViVMOriginalLocationRecoverySpec {
