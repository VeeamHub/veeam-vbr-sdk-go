...
func (o *GetJobParams) WithID(id strfmt.UUID) *GetJobParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get job params
func (o *GetJobParams) SetID(id strfmt.UUID) {
	o.ID = id
}

// WithXAPIVersion adds the xAPIVersion to the get job params
func (o *GetJobParams) WithXAPIVersion(xAPIVersion string) *GetJobParams {
	o.SetXAPIVersion(xAPIVersion)
	return o
}

// SetXAPIVersion adds the xApiVersion to the get job params
func (o *GetJobParams) SetXAPIVersion(xAPIVersion string) {
