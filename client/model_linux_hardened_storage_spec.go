...
// LinuxHardenedStorageSpec Linux hardened repository.
...
func NewLinuxHardenedStorageSpec(hostId string, repository LinuxHardenedRepositorySettingsModel, mountServer MountServerSettingsModel, name string, description string, type_ ERepositoryType) *LinuxHardenedStorageSpec {
	this := LinuxHardenedStorageSpec{}
	this.Name = name
...
func (o LinuxHardenedStorageSpec) MarshalJSON() ([]byte, error) {
...
type NullableLinuxHardenedStorageSpec struct {
	value *LinuxHardenedStorageSpec
	isSet bool
}

func (v NullableLinuxHardenedStorageSpec) Get() *LinuxHardenedStorageSpec {
	return v.value
}

func (v *NullableLinuxHardenedStorageSpec) Set(val *LinuxHardenedStorageSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableLinuxHardenedStorageSpec) IsSet() bool {
	return v.isSet
}

func (v *NullableLinuxHardenedStorageSpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinuxHardenedStorageSpec(val *LinuxHardenedStorageSpec) *NullableLinuxHardenedStorageSpec {
	return &NullableLinuxHardenedStorageSpec{value: val, isSet: true}
}

func (v NullableLinuxHardenedStorageSpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinuxHardenedStorageSpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
