...
// RepositoriesResult struct for RepositoriesResult
...
func (o RepositoriesResult) MarshalJSON() ([]byte, error) {
...
type NullableRepositoriesResult struct {
	value *RepositoriesResult
	isSet bool
}

func (v NullableRepositoriesResult) Get() *RepositoriesResult {
	return v.value
}

func (v *NullableRepositoriesResult) Set(val *RepositoriesResult) {
	v.value = val
	v.isSet = true
}

func (v NullableRepositoriesResult) IsSet() bool {
	return v.isSet
}

func (v *NullableRepositoriesResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRepositoriesResult(val *RepositoriesResult) *NullableRepositoriesResult {
	return &NullableRepositoriesResult{value: val, isSet: true}
}

func (v NullableRepositoriesResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRepositoriesResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
