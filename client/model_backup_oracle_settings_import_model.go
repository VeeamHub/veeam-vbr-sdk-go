...
func (o *BackupOracleSettingsImportModel) GetDeleteHoursCount() int32 {
	if o == nil || isNil(o.DeleteHoursCount) {
		var ret int32
		return ret
	}
...
func (o *BackupOracleSettingsImportModel) GetDeleteGBsCount() int32 {
	if o == nil || isNil(o.DeleteGBsCount) {
		var ret int32
		return ret
	}
