...
func NewAzureDataBoxStorageSpec(account AzureDataBoxStorageAccountModel, container AzureDataBoxStorageContainerModel, name string, description string, type_ ERepositoryType) *AzureDataBoxStorageSpec {
