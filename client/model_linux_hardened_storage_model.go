...
// LinuxHardenedStorageModel Linux hardened repository.
...
func NewLinuxHardenedStorageModel(hostId string, repository LinuxHardenedRepositorySettingsModel, mountServer MountServerSettingsModel, id string, name string, description string, type_ ERepositoryType) *LinuxHardenedStorageModel {
	this := LinuxHardenedStorageModel{}
	this.Id = id
	this.Name = name
...
func (o LinuxHardenedStorageModel) MarshalJSON() ([]byte, error) {
...
type NullableLinuxHardenedStorageModel struct {
	value *LinuxHardenedStorageModel
	isSet bool
}

func (v NullableLinuxHardenedStorageModel) Get() *LinuxHardenedStorageModel {
	return v.value
}

func (v *NullableLinuxHardenedStorageModel) Set(val *LinuxHardenedStorageModel) {
	v.value = val
	v.isSet = true
}

func (v NullableLinuxHardenedStorageModel) IsSet() bool {
	return v.isSet
}

func (v *NullableLinuxHardenedStorageModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinuxHardenedStorageModel(val *LinuxHardenedStorageModel) *NullableLinuxHardenedStorageModel {
	return &NullableLinuxHardenedStorageModel{value: val, isSet: true}
}

func (v NullableLinuxHardenedStorageModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinuxHardenedStorageModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
