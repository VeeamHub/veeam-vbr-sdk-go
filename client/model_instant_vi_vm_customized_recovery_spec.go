...
func NewInstantViVMCustomizedRecoverySpec(destination InstantViVMCustomizedRecoveryDestinationSpec, datastore InstantViVMCustomizedRecoveryDatastoreSpec, objectRestorePointId string, type_ EInstantVMRecoveryModeType, secureRestore SecureRestoreSpec) *InstantViVMCustomizedRecoverySpec {
