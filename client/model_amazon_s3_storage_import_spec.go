...
// AmazonS3StorageImportSpec struct for AmazonS3StorageImportSpec
...
func NewAmazonS3StorageImportSpec(name string, description string, tag string, type_ ERepositoryType, account AmazonS3StorageAccountImportModel, bucket AmazonS3StorageBucketModel, mountServer MountServerSettingsImportSpec) *AmazonS3StorageImportSpec {
	this := AmazonS3StorageImportSpec{}
	this.Name = name
...
func (o AmazonS3StorageImportSpec) MarshalJSON() ([]byte, error) {
...
type NullableAmazonS3StorageImportSpec struct {
	value *AmazonS3StorageImportSpec
	isSet bool
}

func (v NullableAmazonS3StorageImportSpec) Get() *AmazonS3StorageImportSpec {
	return v.value
}

func (v *NullableAmazonS3StorageImportSpec) Set(val *AmazonS3StorageImportSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableAmazonS3StorageImportSpec) IsSet() bool {
	return v.isSet
}

func (v *NullableAmazonS3StorageImportSpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAmazonS3StorageImportSpec(val *AmazonS3StorageImportSpec) *NullableAmazonS3StorageImportSpec {
	return &NullableAmazonS3StorageImportSpec{value: val, isSet: true}
}

func (v NullableAmazonS3StorageImportSpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAmazonS3StorageImportSpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
