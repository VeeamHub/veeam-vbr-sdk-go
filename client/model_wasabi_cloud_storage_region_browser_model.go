...
// WasabiCloudStorageRegionBrowserModel struct for WasabiCloudStorageRegionBrowserModel
...
func NewWasabiCloudStorageRegionBrowserModel() *WasabiCloudStorageRegionBrowserModel {
	this := WasabiCloudStorageRegionBrowserModel{}
	return &this
}
...
func (o *WasabiCloudStorageRegionBrowserModel) GetBuckets() []WasabiCloudStorageBucketBrowserModel {
	if o == nil || isNil(o.Buckets) {
		var ret []WasabiCloudStorageBucketBrowserModel
		return ret
	}
	return o.Buckets
}
...
// SetBuckets gets a reference to the given []WasabiCloudStorageBucketBrowserModel and assigns it to the Buckets field.
func (o *WasabiCloudStorageRegionBrowserModel) SetBuckets(v []WasabiCloudStorageBucketBrowserModel) {
	o.Buckets = v
}

func (o WasabiCloudStorageRegionBrowserModel) MarshalJSON() ([]byte, error) {
...
type NullableWasabiCloudStorageRegionBrowserModel struct {
	value *WasabiCloudStorageRegionBrowserModel
	isSet bool
}

func (v NullableWasabiCloudStorageRegionBrowserModel) Get() *WasabiCloudStorageRegionBrowserModel {
	return v.value
}

func (v *NullableWasabiCloudStorageRegionBrowserModel) Set(val *WasabiCloudStorageRegionBrowserModel) {
	v.value = val
	v.isSet = true
}

func (v NullableWasabiCloudStorageRegionBrowserModel) IsSet() bool {
	return v.isSet
}

func (v *NullableWasabiCloudStorageRegionBrowserModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWasabiCloudStorageRegionBrowserModel(val *WasabiCloudStorageRegionBrowserModel) *NullableWasabiCloudStorageRegionBrowserModel {
	return &NullableWasabiCloudStorageRegionBrowserModel{value: val, isSet: true}
}

func (v NullableWasabiCloudStorageRegionBrowserModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWasabiCloudStorageRegionBrowserModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
