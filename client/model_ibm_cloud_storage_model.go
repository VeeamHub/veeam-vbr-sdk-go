...
func NewIBMCloudStorageModel(account IBMCloudStorageAccountModel, bucket IBMCloudStorageBucketModel, mountServer MountServerSettingsModel, id string, name string, description string, type_ ERepositoryType) *IBMCloudStorageModel {
