...
// All allowed values of EProxiesFiltersOrderColumn enum
var AllowedEProxiesFiltersOrderColumnEnumValues = []EProxiesFiltersOrderColumn{
	"Name",
	"Type",
	"Description",
}
...
func (v *EProxiesFiltersOrderColumn) UnmarshalJSON(src []byte) error {
	...
	for _, existing := range AllowedEProxiesFiltersOrderColumnEnumValues {
...
// NewEProxiesFiltersOrderColumnFromValue returns a pointer to a valid EProxiesFiltersOrderColumn
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewEProxiesFiltersOrderColumnFromValue(v string) (*EProxiesFiltersOrderColumn, error) {
	ev := EProxiesFiltersOrderColumn(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for EProxiesFiltersOrderColumn: valid values are %v", v, AllowedEProxiesFiltersOrderColumnEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v EProxiesFiltersOrderColumn) IsValid() bool {
	for _, existing := range AllowedEProxiesFiltersOrderColumnEnumValues {
		if existing == v {
			return true
		}
