...
func NewAzureComputeCloudCredentialsSpec(connectionName string, creationMode EAzureComputeCredentialsCreationMode, type_ ECloudCredentialsType) *AzureComputeCloudCredentialsSpec {
