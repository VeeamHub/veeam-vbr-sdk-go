...
// GetWindowSetting returns the WindowSetting field value if set, zero value otherwise.
func (o *ScheduleBackupWindowModel) GetWindowSetting() BackupWindowSettingModel {
	if o == nil || o.WindowSetting == nil {
		var ret BackupWindowSettingModel
		return ret
	}
	return *o.WindowSetting
}

// GetWindowSettingOk returns a tuple with the WindowSetting field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ScheduleBackupWindowModel) GetWindowSettingOk() (*BackupWindowSettingModel, bool) {
	if o == nil || o.WindowSetting == nil {
		return nil, false
	}
	return o.WindowSetting, true
}
...
// SetWindowSetting gets a reference to the given BackupWindowSettingModel and assigns it to the WindowSetting field.
...
func (o ScheduleBackupWindowModel) MarshalJSON() ([]byte, error) {
	...
	if o.WindowSetting != nil {
		toSerialize["WindowSetting"] = o.WindowSetting
	}
