...
// AmazonSnowballEdgeBrowserDestinationSpecAllOf struct for AmazonSnowballEdgeBrowserDestinationSpecAllOf
type AmazonSnowballEdgeBrowserDestinationSpecAllOf struct {
...
func NewAmazonSnowballEdgeBrowserDestinationSpecAllOf(connectionPoint string, regionId string, bucketName string) *AmazonSnowballEdgeBrowserDestinationSpecAllOf {
	this := AmazonSnowballEdgeBrowserDestinationSpecAllOf{}
...
func (o AmazonSnowballEdgeBrowserDestinationSpecAllOf) MarshalJSON() ([]byte, error) {
...
type NullableAmazonSnowballEdgeBrowserDestinationSpecAllOf struct {
	value *AmazonSnowballEdgeBrowserDestinationSpecAllOf
	isSet bool
}

func (v NullableAmazonSnowballEdgeBrowserDestinationSpecAllOf) Get() *AmazonSnowballEdgeBrowserDestinationSpecAllOf {
	return v.value
}

func (v *NullableAmazonSnowballEdgeBrowserDestinationSpecAllOf) Set(val *AmazonSnowballEdgeBrowserDestinationSpecAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableAmazonSnowballEdgeBrowserDestinationSpecAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableAmazonSnowballEdgeBrowserDestinationSpecAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAmazonSnowballEdgeBrowserDestinationSpecAllOf(val *AmazonSnowballEdgeBrowserDestinationSpecAllOf) *NullableAmazonSnowballEdgeBrowserDestinationSpecAllOf {
	return &NullableAmazonSnowballEdgeBrowserDestinationSpecAllOf{value: val, isSet: true}
}

func (v NullableAmazonSnowballEdgeBrowserDestinationSpecAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAmazonSnowballEdgeBrowserDestinationSpecAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
