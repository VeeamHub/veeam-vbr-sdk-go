...
// ServicesFilters struct for ServicesFilters
...
func (o *ServicesFilters) GetOrderColumn() EServicesFiltersOrderColumn {
	if o == nil || isNil(o.OrderColumn) {
		var ret EServicesFiltersOrderColumn
		return ret
	}
...
// SetOrderColumn gets a reference to the given EServicesFiltersOrderColumn and assigns it to the OrderColumn field.
...
func (o ServicesFilters) MarshalJSON() ([]byte, error) {
...
type NullableServicesFilters struct {
	value *ServicesFilters
	isSet bool
}

func (v NullableServicesFilters) Get() *ServicesFilters {
	return v.value
}

func (v *NullableServicesFilters) Set(val *ServicesFilters) {
	v.value = val
	v.isSet = true
}

func (v NullableServicesFilters) IsSet() bool {
	return v.isSet
}

func (v *NullableServicesFilters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServicesFilters(val *ServicesFilters) *NullableServicesFilters {
	return &NullableServicesFilters{value: val, isSet: true}
}

func (v NullableServicesFilters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServicesFilters) UnmarshalJSON(src []byte) error {
	v.isSet = true
