...
// WasabiCloudStorageSpec Wasabi Cloud storage.
...
func NewWasabiCloudStorageSpec(account WasabiCloudStorageAccountModel, bucket WasabiCloudStorageBucketModel, mountServer MountServerSettingsModel, hostId string, repository LinuxHardenedRepositorySettingsModel, share SmbRepositoryShareSettingsModel, container AzureArchiveStorageContainerModel) *WasabiCloudStorageSpec {
	this := WasabiCloudStorageSpec{}
	this.HostId = hostId
...
func (o WasabiCloudStorageSpec) MarshalJSON() ([]byte, error) {
...
type NullableWasabiCloudStorageSpec struct {
	value *WasabiCloudStorageSpec
	isSet bool
}

func (v NullableWasabiCloudStorageSpec) Get() *WasabiCloudStorageSpec {
	return v.value
}

func (v *NullableWasabiCloudStorageSpec) Set(val *WasabiCloudStorageSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableWasabiCloudStorageSpec) IsSet() bool {
	return v.isSet
}

func (v *NullableWasabiCloudStorageSpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWasabiCloudStorageSpec(val *WasabiCloudStorageSpec) *NullableWasabiCloudStorageSpec {
	return &NullableWasabiCloudStorageSpec{value: val, isSet: true}
}

func (v NullableWasabiCloudStorageSpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWasabiCloudStorageSpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
