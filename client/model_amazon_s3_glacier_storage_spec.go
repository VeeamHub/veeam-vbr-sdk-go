...
func NewAmazonS3GlacierStorageSpec(account AmazonS3StorageAccountModel, bucket AmazonS3GlacierStorageBucketModel, name string, description string, type_ ERepositoryType) *AmazonS3GlacierStorageSpec {
