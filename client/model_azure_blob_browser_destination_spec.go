...
func NewAzureBlobBrowserDestinationSpec(regionType EAzureRegionType, containerName string, servicePoint string, regionId string, bucketName string, connectionPoint string) *AzureBlobBrowserDestinationSpec {
