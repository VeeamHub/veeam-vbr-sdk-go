...
func NewAmazonEC2BrowserModel(hostId string, regionType EAmazonRegionType, regions []AmazonEC2RegionBrowserModel, credentialsId string, serviceType ECloudServiceType) *AmazonEC2BrowserModel {
