...
// JobsResult struct for JobsResult
...
func (o JobsResult) MarshalJSON() ([]byte, error) {
...
type NullableJobsResult struct {
	value *JobsResult
	isSet bool
}

func (v NullableJobsResult) Get() *JobsResult {
	return v.value
}

func (v *NullableJobsResult) Set(val *JobsResult) {
	v.value = val
	v.isSet = true
}

func (v NullableJobsResult) IsSet() bool {
	return v.isSet
}

func (v *NullableJobsResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJobsResult(val *JobsResult) *NullableJobsResult {
	return &NullableJobsResult{value: val, isSet: true}
}

func (v NullableJobsResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJobsResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
