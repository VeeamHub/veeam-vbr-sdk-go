...
// AmazonS3StorageModel Amazon S3 storage.
...
func NewAmazonS3StorageModel(account AmazonS3StorageAccountModel, bucket AmazonS3StorageBucketModel, mountServer MountServerSettingsModel, hostId string, repository LinuxHardenedRepositorySettingsModel, share SmbRepositoryShareSettingsModel, container AzureArchiveStorageContainerModel) *AmazonS3StorageModel {
	this := AmazonS3StorageModel{}
	this.HostId = hostId
...
func (o AmazonS3StorageModel) MarshalJSON() ([]byte, error) {
...
type NullableAmazonS3StorageModel struct {
	value *AmazonS3StorageModel
	isSet bool
}

func (v NullableAmazonS3StorageModel) Get() *AmazonS3StorageModel {
	return v.value
}

func (v *NullableAmazonS3StorageModel) Set(val *AmazonS3StorageModel) {
	v.value = val
	v.isSet = true
}

func (v NullableAmazonS3StorageModel) IsSet() bool {
	return v.isSet
}

func (v *NullableAmazonS3StorageModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAmazonS3StorageModel(val *AmazonS3StorageModel) *NullableAmazonS3StorageModel {
	return &NullableAmazonS3StorageModel{value: val, isSet: true}
}

func (v NullableAmazonS3StorageModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAmazonS3StorageModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
