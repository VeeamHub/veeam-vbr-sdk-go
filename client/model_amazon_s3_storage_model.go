...
func NewAmazonS3StorageModel(account AmazonS3StorageAccountModel, bucket AmazonS3StorageBucketModel, mountServer MountServerSettingsModel, id string, name string, description string, type_ ERepositoryType) *AmazonS3StorageModel {
