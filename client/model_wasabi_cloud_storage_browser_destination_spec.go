...
func NewWasabiCloudStorageBrowserDestinationSpec(regionId string, bucketName string, credentialsId string, serviceType ECloudServiceType, newFolderName string) *WasabiCloudStorageBrowserDestinationSpec {
