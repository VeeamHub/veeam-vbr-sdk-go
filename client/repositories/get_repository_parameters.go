...
// WithID adds the id to the get repository params
func (o *GetRepositoryParams) WithID(id strfmt.UUID) *GetRepositoryParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get repository params
func (o *GetRepositoryParams) SetID(id strfmt.UUID) {
	o.ID = id
}

// WithXAPIVersion adds the xAPIVersion to the get repository params
func (o *GetRepositoryParams) WithXAPIVersion(xAPIVersion string) *GetRepositoryParams {
	o.SetXAPIVersion(xAPIVersion)
	return o
}

// SetXAPIVersion adds the xApiVersion to the get repository params
func (o *GetRepositoryParams) SetXAPIVersion(xAPIVersion string) {
