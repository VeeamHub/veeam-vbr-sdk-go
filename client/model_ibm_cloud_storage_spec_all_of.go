...
// IBMCloudStorageSpecAllOf struct for IBMCloudStorageSpecAllOf
type IBMCloudStorageSpecAllOf struct {
...
func (o IBMCloudStorageSpecAllOf) MarshalJSON() ([]byte, error) {
...
type NullableIBMCloudStorageSpecAllOf struct {
	value *IBMCloudStorageSpecAllOf
	isSet bool
}

func (v NullableIBMCloudStorageSpecAllOf) Get() *IBMCloudStorageSpecAllOf {
	return v.value
}

func (v *NullableIBMCloudStorageSpecAllOf) Set(val *IBMCloudStorageSpecAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableIBMCloudStorageSpecAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableIBMCloudStorageSpecAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIBMCloudStorageSpecAllOf(val *IBMCloudStorageSpecAllOf) *NullableIBMCloudStorageSpecAllOf {
	return &NullableIBMCloudStorageSpecAllOf{value: val, isSet: true}
}

func (v NullableIBMCloudStorageSpecAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIBMCloudStorageSpecAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
