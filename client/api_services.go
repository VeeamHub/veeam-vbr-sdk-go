...
*/
func (a *ServicesApiService) GetAllServices(ctx context.Context) ApiGetAllServicesRequest {
	return ApiGetAllServicesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ServicesApiService) GetAllServicesExecute(r ApiGetAllServicesRequest) (*ServicesResult, *http.Response, error) {
	var (
